...
export function ServiceTabs() {
  return (
    <section className="container mx-auto py-24 px-4">
      <Tabs defaultValue="passport" className="w-full max-w-4xl mx-auto">
        <TabsList className="grid w-full grid-cols-2 mb-12">
          <TabsTrigger value="passport" className="text-lg py-6">
            <Compass className="mr-2 h-5 w-5" />
            Passport to Freedom
          </TabsTrigger>
          <TabsTrigger value="tailor" className="text-lg py-6">
